...
@patch("backend.agents.jarvis._client")
class TestAskJarvis:
    def test_direct_answer_no_tool_call(self, mock_client, sample_transactions):
        """If the model answers without calling a tool, return its content as-is."""
